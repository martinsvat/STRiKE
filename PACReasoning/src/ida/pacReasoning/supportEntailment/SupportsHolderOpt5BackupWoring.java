...
/**
 * fungující implementace která byla použitá pro výpočet ECAI článku; na větších evidencích neškáluje (>1500 faktů)
 * Version with bruteforce forbidden.
 *
 * Created by martin.svatos on 15. 10. 2018.
 */
public class SupportsHolderOpt5BackupWoring {
...
//        System.out.println("SupportsHolder -- todo: namisto metody mask pouzit nejakou jinou datovou strukturu aby i support mel seznam literalu ktere uvozuje");
    ...
    public SupportsHolderOpt5BackupWoring(int k, Set<Literal> evidence, Map<Constant, Subset> constantToSubset, List<Constant> evidenceConstants, Map<Literal, Set<Support>> map, Map<Subset, Support> supportCache, Map<Pair<String, Integer>, Integer> predicatesIdx, boolean useExtraPruning) {
        this.k = k;
...
//        }
    ...
    public static SupportsHolderOpt5BackupWoring create(Set<Literal> evidence, int k, Map<Pair<String, Integer>, Integer> predicatesToBitset, boolean useExtraPruning) {
        ...
        return new SupportsHolderOpt5BackupWoring(k, evidence, constantToSubset, constants, map, //heads,
