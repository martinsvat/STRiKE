 ...
 */
public class SupportsHolderOpt8ForwardMoreThanOne {
...
//        }
    ...
    public static SupportsHolderOpt8ForwardMoreThanOne create(Set<Literal> evidence, int k, Map<Pair<String, Integer>, Integer> predicatesToBitset, boolean useExtraPruning) {
        ...
        return new SupportsHolderOpt8ForwardMoreThanOne(k, evidence, constantToSubset, constants, map, //heads,
