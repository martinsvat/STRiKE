...
public class BreadthResults {
    ...
    public List<Set<SearchNodeInfo>> getReducedFeatures() {
        return reducedFeatures;
    }

    public void join(int idx, Set<SearchNodeInfo> memory, MutableStats stats, long constraintTime, long hardRules, long minSuppHardRules) {
